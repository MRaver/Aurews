...
function saveSignUp() {
    ...
    signUpForm.addEventListener('submit', async (e) => {
        ...
        if (password !== confirmPass) {
            ...
            //backend
            // const res = await fetch('stringify',
            //     {
            //         method: 'POST',
...
//     try {
//         const res = await fetch('https://your-backend-api.com/me', {
//             method: 'GET',
//             headers: {
...
function userLoginHTML() {
    const tokenn = JSON.parse(localStorage.getItem('userInfo'));
    let role;
